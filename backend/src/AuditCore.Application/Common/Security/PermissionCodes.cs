...
public static class PermissionCodes
{
    ...
    public const string FrameworksView = "FRAMEWORKS.VIEW";
    public const string FrameworksManage = "FRAMEWORKS.MANAGE";
    ...
    [
        OrganizationsView, OrganizationsManage,
        UsersView, UsersManage,
        RolesView, RolesManage,
        AuditsView, AuditsCreate, AuditsUpdate, AuditsExecute, AuditsClose,
        FrameworksView, FrameworksManage,
        EvidenceView, EvidenceManage,
        FindingsView, FindingsManage,
        RisksView, RisksManage,
        ActionPlansView, ActionPlansManage,
