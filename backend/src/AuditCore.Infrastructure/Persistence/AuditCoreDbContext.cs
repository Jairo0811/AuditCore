...
public sealed class AuditCoreDbContext
    : DbContext, IAuditCoreDbContext
{
    public AuditCoreDbContext(
        DbContextOptions<AuditCoreDbContext> options)
        : base(options)
    {
    }
        ...
        ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(
            typeof(AuditCoreDbContext).Assembly);
